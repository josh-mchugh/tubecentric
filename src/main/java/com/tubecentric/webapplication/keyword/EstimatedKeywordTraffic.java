...
public class EstimatedKeywordTraffic {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Credential oAuth2Credential = new GoogleCredential.Builder()
                            ...
                            .setClientSecrets("1012307943371-o5np4nvb0hk1jd97636sumkv98l71mkn.apps.googleusercontent.com","86i8xMfSvIpCQ4HuQzbcz-Yn")
                            .build()
                            .setRefreshToken("1/NH1Nr2esNjmKNEBbvtqnW7oRptD9BkV_yRV2k3JDFeNPyhiEf2xMAhlm3b-SRGn0");

            // Construct an AdWordsSession.
            session = new AdWordsSession.Builder()
                    .withDeveloperToken("YrCK3Nc8L0ufVz0ICwwAKA")
                    .withClientCustomerId("763-371-5833")
    ...
    public static void runExample(
        ...
        List<CampaignEstimateRequest> campaignEstimateRequests = new ArrayList<>();
    ...
    private static void displayMeanEstimates(String message, StatsEstimate minEstimate,
        ...
        Double meanAverageCpc = calculateMean(minEstimate.getAverageCpc(), maxEstimate.getAverageCpc());
        Double meanAveragePosition = calculateMean(minEstimate.getAveragePosition(),  maxEstimate.getAveragePosition());
        Double meanClicks = calculateMean(minEstimate.getClicksPerDay(), maxEstimate.getClicksPerDay());
        Double meanTotalCost = calculateMean(minEstimate.getTotalCost(), maxEstimate.getTotalCost());
        Double meanImpressions = calculateMean(minEstimate.getImpressionsPerDay(), maxEstimate.getImpressionsPerDay());

        System.out.println(message);
        System.out.printf("\tEstimated avg impressions per day: %s%n", formatMean(meanImpressions));
