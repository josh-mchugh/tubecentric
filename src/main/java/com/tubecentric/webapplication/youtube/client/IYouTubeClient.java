...
import com.tubecentric.webapplication.framework.config.FeignConfig;
...
@FeignClient(name = "youtubeClient", url = "${app.youtube.base-url}", configuration = FeignConfig.class)
